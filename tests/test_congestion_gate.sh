...
CONSTS=$(grep -E "^CONGESTION_PROBE_TARGETS=|^CONGESTION_RTT_MAX=|^CONGESTION_LOSS_MAX=|^CONGESTION_HOLD_MAX=|^STORM_503_RECENT=|^PROXY_BROKEN_GRACE=|^STORM_503_STATE=" "$WATCHDOG")
